...
class FogOfWar:
    def __init__(self, visibility_radius=150, fog_image_path="resources/fog.png"):
        self.visibility_radius = visibility_radius
        #import picture for fog
        self.fog_light = pygame.image.load(fog_image_path).convert_alpha()
        self.fog_light = pygame.transform.scale(self.fog_light, (visibility_radius * 2, visibility_radius * 2))
    ...
    def update(self, player_pos, camera_offset):
        ...
        self.fog_surface.fill((0, 0, 0, 180))  # Semi-transparent black
